...
#              The positive x-axis points to the right and runs along the top of the screen.
#
#        -- In what direction on the screen
#           does the positive Y-axis point?
#              The positive y-axis points down and runs along the left side of the screen.
#
...
#            draws all objects on the window
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            When the person writing the code wants the window to stay open so whoever is running the code
#            can view the window as long as they want.
#
